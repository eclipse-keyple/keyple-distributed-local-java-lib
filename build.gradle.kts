...
dependencies {
    ...
    implementation("org.eclipse.keyple:keyple-distributed-local-java-api:2.0-rc1")
    implementation("org.eclipse.keyple:keyple-distributed-network-java-lib:2.0.0-rc1")
